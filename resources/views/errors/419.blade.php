    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark">
        ...
        <div class="relative flex min-h-screen items-center justify-center overflow-hidden">
            <div
                ...
                <div class="relative">
                    {{-- <img src="{{ url('themes/vristo/images/error/404-dark.svg') }}" alt="404"
                        class="mx-auto -mt-10 w-full max-w-xs object-cover md:-mt-14 md:max-w-xl" /> --}}

                    <img src="{{ url('themes/vristo/images/error/419-error-page-not-found-rafiki.svg') }}" alt="419"
                        class="mx-auto -mt-10 w-full max-w-xs object-cover md:-mt-14 md:max-w-xl" />

                    <p class="mt-5 text-base dark:text-white">{{ __('messages.419PageExpired') }}</p>
                    <a href="{{ url()->previous() }}"
