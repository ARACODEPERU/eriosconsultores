...
<head>
    ...
    <style>
        ...
        .boton-degradado-campus {
            ...
            border: none;
            border-radius: 10px;
            background: linear-gradient(45deg, #44afcf, #184085);
            color: white;
            font-size: 16px;
            cursor: pointer;
        ...
        .boton-degradado-campus:hover {
            ...
            background: linear-gradient(45deg, #184085, #44afcf);
        }
...
<body>
    ...
    <div class="container">
        ...
        <p style="text-align: center; font-size: 14px;">
            EDUCAP, Distrito de Chimbote, Provincia del Santa, Perú, +51 916268352
        </p>
        <br>
        <footer>
