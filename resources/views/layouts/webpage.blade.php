...
<body>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index-4.html">
                                <img src="{{  asset('themes/webpage/images/logo.png') }}" alt="Logo">
                            </a>
    ...
    <section id="slider-part" class="slider-active ">
        <div class="single-slider bg_cover pt-150" style="background-image: url({{ asset('themes/webpage/images/slider/s-1.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url({{ asset('themes/webpage/images/slider/s-3.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url({{ asset('themes/webpage/images/slider/s-2.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
            ...
            <div class="row course-slide mt-30">
                    ...
                    <div class="single-course">
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img src="{{ asset('themes/webpage/images/course/teacher/t-1.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                ...
                <div class="col-lg-4">
                    <div class="single-course">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('themes/webpage/images/course/cu-2.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img src="{{ asset('themes/webpage/images/course/teacher/t-2.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
    ...
    <section id="video-feature" class="bg_cover pt-60 pb-110" style="background-image: url({{ asset('themes/webpage/images/bg-1.jpg') }})">
        <div class="container">
                        ...
                        <ul>
                            <li>
                                <div class="single-feature">
                                    <div class="icon">
                                        <img src="{{ asset('themes/webpage/images/all-icon/f-1.png') }}" alt="icon">
                                    </div>
                                    <div class="cont">
                            ...
                            <li>
                                <div class="single-feature">
                                    <div class="icon">
                                        <img src="{{ asset('themes/webpage/images/all-icon/f-2.png') }}" alt="icon">
                                    </div>
                                    <div class="cont">
                            ...
                            <li>
                                <div class="single-feature">
                                    <div class="icon">
                                        <img src="{{ asset('themes/webpage/images/all-icon/f-3.png') }}" alt="icon">
                                    </div>
                                    <div class="cont">
                                        <h4>Books & Library</h4>
                                        <p>Gravida nibh vel velit auctor aliquetn auci elit cons solliazcitudirem sem quibibendum sem nibhutis.</p>
    ...
    <section id="testimonial" class="bg_cover pt-115 pb-115" data-overlay="8" style="background-image: url({{ asset('themes/webpage/images/bg-2.jpg') }})">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
