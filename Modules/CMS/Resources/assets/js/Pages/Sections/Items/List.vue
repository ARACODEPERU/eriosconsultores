...
<template>
    <AppLayout title="Items de la sección">
        <div class="mt-5">
            <Navigation
                :routeModule="route('cms_dashboard')"
                :titleModule="'CMS'"
                :data="[
                    { title: 'Secciones', route: route('cms_section_list') },
                                        ...
                                        <li v-for="(item, index) in arrayItems.data" class="py-3 sm:py-4">
                                            ...
                                            <div class="flex flex-wrap items-center gap-2 mt-1">
                                                <label class="inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                                    Posición
                                                    <input style="width: 70px;" class="form-input" type="number" v-model="item.si_position">
                                                </label>
                                                <button @click="destroyItem(item.si_id)" type="button" class="btn btn-sm btn-outline-danger">Eliminar Item</button>
                                            </div>
